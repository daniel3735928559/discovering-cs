...
app.controller("AvrSimController", function($scope){
	...
	"01011":{
	    "name":"VAL = VAL1 + VAL2",
	    "exec":function(inst){
		return {"controls":$scope.set_controls({"VAL_we":1,"VAL_sel":1,"A_sel":0,"B_sel":0,"ALU_op":0}),
	...
	"01110":{
	    "name":"VAL = OFF+PC",
	    "exec":function(inst){
		return {"controls":$scope.set_controls({"VAL_we":1,"VAL_sel":1,"A_sel":1,"B_sel":1,"ALU_op":1}),
	...
	$scope.uarch_image = "/lib/uarch/pngs/uarch-"+inst.mnemonic+"."+$scope.uarch_inst_cycle+".png";
	$scope.sm_image = "/lib/uarch/pngs/statemachine-"+inst.mnemonic+"."+$scope.uarch_inst_cycle+".png";
