...
app.controller("BoxController", ['$scope','$http','$cookies', '$window', '$timeout', '$location', '$anchorScroll', function($scope, $http, $cookies, $window, $timeout, $location, $anchorScroll){
    ...
    $scope.login = {};
    $scope.comment = {};
    $scope.comments = {"1.3.1.p11":[{"author":"Daniel","text":"Dara O Briain talks about the black boxes of everyday life: https://www.youtube.com/watch?v=BVxOb8-d7Ic  (warning: language)"}],"1.6.p8":[{"author":"Daniel","text":"A Flash game based on a slightly different but equivalent model of Turing machines: http://pleasingfungus.com/Manufactoria/"}]}
    ...
    $scope.show_binary_expl = function(){
	$scope.display_binary_expl = true;
    }
